...
public class Exp3 {
    ...
    private NearestNeighborsKD NNKD;
    ...
    public Exp3(List<Point3D> DB){
        this.DB = DB;
        NNKD = new NearestNeighborsKD(DB);
    }
	...
	*/
    ...
    public void findClusters(){
        ...
        for(Point3D P : DB) {
            ...
            List<Point3D> N = NNKD.rangeQuery(P,epsilon); /* Find neighbors */
            ...
            while (!S.empty()) { 
                ...
                N = NNKD.rangeQuery(Q,epsilon); /* Find neighbors */
                if (N.size() >= minpts) { /* Density check */
